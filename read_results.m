function read_results(Q,Period,cellInputFile,solutionFile)

%% Get needed informationn

Var_name = get_stage_vectors(-1);
[A,~,~,cost,Zones] = get_stage_vectors('base');
[~,A_full,b_vec] = get_stage_vectors(1,1);
